...
export const workspaceSourcePaths = {
	...
	telemetryNode: fileURLToPath(new URL("./packages/telemetry/src/node.ts", import.meta.url)),
...
export default defineConfig({
	resolve: {
		alias: [
			...
			{ find: /^@earendil-works\/pi-telemetry\/node$/, replacement: workspaceSourcePaths.telemetryNode },
