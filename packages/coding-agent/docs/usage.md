...
Run `hummin` from the folder you want to work in. hummin uses that folder to discover files, instructions, and configuration, and to group saved sessions. If you have not installed hummin or chosen a model yet, follow the [Quickstart](quickstart.md).
