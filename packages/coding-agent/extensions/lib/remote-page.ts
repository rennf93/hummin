...
<header><h1>hummin</h1><div id="status" role="status">Connecting…</div></header>
...
<small>Messages sent during a response are queued. Approval dialogs stay in the terminal.</small><div id="error" role="alert"></div></form>
<script>
