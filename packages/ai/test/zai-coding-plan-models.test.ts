...
it("uses API-equivalent reference costs for Coding Plan models", () => {
	...
	// glm-5.3 replaced glm-5.1 on the China Coding Plan catalog at the same price point
	...
	// zai glm-5-turbo carries the turbo price point previously covered by coding-plan glm-5v-turbo
...
it("keeps zero costs for Coding Plan models without a matching API price", () => {
	...
	expect(getBuiltinModel("zai", "glm-5.3-highspeed").cost).toEqual(zeroCost);
